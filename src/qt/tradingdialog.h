...
private slots:
    ...
    QString BuySTAK(QString OrderType, double Quantity, double Rate);
    QString SellSTAK(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"STAK/BTC\"}"));
