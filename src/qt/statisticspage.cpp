...
void StatisticsPage::updateStatistics()
{
	...
	int64_t marketcap = STAKmarket.toDouble();
    ...
    {
        subsidy = "3 STAK per block";
    }
	else if (pindexBest->nHeight < 2000000)
    {
        subsidy = "4 STAK per block";
    }
	else if (pindexBest->nHeight < 3000000)
    {
        subsidy = "3 STAK per block";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " STAK" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " STAK" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " STAK" + "</font></b>");
    }
