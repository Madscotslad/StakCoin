...
const QString BaseURL = "http://denarius.io/STAKusd.php";
const QString BaseURL2 = "http://denarius.io/STAKbtc.php";
double denariusx;
double STAKbtcx;
...
if (what == BaseURL2) // Denarius BTC Price
{
    ...
    STAKbtcx = (STAKbtc.toDouble());
    STAKbtc = QString::number(STAKbtcx, 'f', 8);
