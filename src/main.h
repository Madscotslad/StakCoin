...
static const int64_t DARKSEND_COLLATERAL = (5000*COIN); // 5,000 STAK
static const int64_t DARKSEND_FEE = (0.010000*COIN); //0.01 STAK
static const int64_t POOL_FEE_AMOUNT = (0.1*COIN); //0.1 STAK
static const int64_t DARKSEND_POOL_MAX = (11000*COIN); //11,000 STAK
...
static const int64_t MAX_MONEY = 10000000 * COIN; // 10,000,000 STAK Denarius Max
