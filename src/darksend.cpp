    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Denarius and make it unusable. To
                stop these kinds of attacks 1 in 50 successful transactions are charged. This
                adds up to a cost of 0.002STAK per transaction on average.
            */
            if(r <= 20)
            {
...
//        }
    ...
    if(!sessionFoundMasternode){
        ...
        printf("Submitting Darksend for %f STAK CENT - sessionTotalValue %lu\n", fDenariusSubmitted, sessionTotalValue);
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("denarius-darksend");
